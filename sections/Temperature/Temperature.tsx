...
export default function Temperature({ temperature, city }: Props) {
  ...
  return (
    <div class="mx-auto my-0 sm:my-8 p-6 min-h-[600px] flex flex-col sm:flex-row sm:justify-between relative bg-slate-300">
      <h1 class="text-lg sm:text-5xl text-left font-bold text-black my-8">
        {city ?? "São Pauo - SP"}
      </h1>
